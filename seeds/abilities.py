Abilities = [
    ...
    {
        "name": "Constitution",
        "description": "A character with high Constitution usually looks healthy, with bright eyes and abundant energy. A character with low Constitution might be sickly or frail.",
        "measures": "Health, Stamina, Vital Force",
        "important_for": "Everyone"
    },
    {
        "name": "Intelligence",
        "description": "A character with high Intelligence might be highly inquisitive and studious, while a character with low Intelligence might speak simply or easily forget details.",
        "measures": "Mental Acuity, Information Recall, Analytical Skill",
        "important_for": "Wizard"
    },
    {
        "name": "Wisdom",
        "description": "A character with high Wisdom has good judgment, empathy, and a general awareness of what’s going on. A character with low Wisdom might be absent-minded, foolhardy, or oblivious.",
        "measures": "Awareness, Intuition, Insight",
        "important_for": "Cleric, Druid"
    },
    {
        "name": "Charisma",
